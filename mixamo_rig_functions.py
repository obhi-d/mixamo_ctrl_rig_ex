...
fk_leg = [c_prefix+leg_rig_names["thigh_fk"], c_prefix+leg_rig_names["calf_fk"], c_prefix+leg_rig_names["foot_fk"], c_prefix+leg_rig_names["toe_fk"]]
ik_leg = [leg_rig_names["thigh_ik"], leg_rig_names["calf_ik"], c_prefix+leg_rig_names["foot_ik"], c_prefix+leg_rig_names["pole_ik"], c_prefix+leg_rig_names["toe_ik"], c_prefix+leg_rig_names["foot_01"], c_prefix+leg_rig_names["foot_roll_cursor"], leg_rig_names["foot_snap"]]
...
def fk_to_ik_leg(self):
    ...
    toe_fk = rig.pose.bones[fk_leg[3] + _side]
    ...
    toe_ik = rig.pose.bones[ik_leg[4] + _side]
    ...
    # Toes snap
    snap_rot(toe_fk, toe_ik)
    toe_fk.scale = toe_ik.scale
    ...
    if bpy.context.scene.tool_settings.use_keyframe_insert_auto:
        ...
        toe_fk.keyframe_insert(data_path="rotation_euler")
        toe_fk.keyframe_insert(data_path="scale")
        ...
        toe_ik.keyframe_insert(data_path="rotation_euler")
        toe_ik.keyframe_insert(data_path="scale")
        pole_ik.keyframe_insert(data_path="location")
...
def ik_to_fk_leg(self):
    ...
    # Snap toes
    toe_ik.rotation_euler = toe_fk.rotation_euler.copy()
    toe_ik.scale = toe_fk.scale.copy()
